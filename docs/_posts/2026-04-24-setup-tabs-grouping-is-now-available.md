...
![Setup Tabs Upgrade (v1.1.0)]({{ '/images/post-images/2026-04-24-setup-tabs-upgrade/grouped-tabs-in-list-view.png' | relative_url }})
...
![Setup Tabs Upgrade (v1.1.0)]({{ '/images/post-images/2026-04-24-setup-tabs-upgrade/grouped-tabs-settings-toggle.png' | relative_url }})
