...
const APINamePrefixes = (() => {
  ...
  function _hardcodedFallback() {
    return [
      ...
      { table: 'element',  type: 'Datatable',                                Snake_Case: 'DTable_',        PascalCase: 'DTable',        camelCase: 'dtable'        },
      { table: 'element',  type: 'LWC',                                      Snake_Case: 'LWC_',           PascalCase: 'LWC',           camelCase: 'lwc'           },
      { table: 'element',  type: 'Radio Button Group',                       Snake_Case: 'Input_',         PascalCase: 'Input',         camelCase: 'input'         },
      ...
      { table: 'resource', type: 'Collection Filter Criteria',               Snake_Case: 'CollFilter_',    PascalCase: 'CollFilter',    camelCase: 'collfilter'    },
